...
module "networking" {
  ...
  pe_private_connection_resource_id = module.openai[0].openai_account_id
  # private_endpoint = {
  #   "pe_endpoint" = {
...
module "webapp" {
  ...
  azure_api_key         = var.deploy_openai ? module.openai[0].openai_primary_key : ""
  azure_openai_endpoint = var.deploy_openai ? module.openai[0].openai_endpoint : ""
